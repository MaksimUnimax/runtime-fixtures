...
export const NoSessionCapabilityExpectationSchema = z.enum([
  "EXPECTED",
  "OPTIONAL_OR_REGION_DEPENDENT",
  "NOT_EXPECTED",
  "NOT_OBSERVABLE_WITHOUT_SESSION",
]);
export type NoSessionCapabilityExpectation = z.infer<
  typeof NoSessionCapabilityExpectationSchema
>;
...
export const NoSessionTargetSchema = z
  .object({
    ...
    capabilityExpectation: z
      .object({
        pageIdentity: NoSessionCapabilityExpectationSchema,
        publicLanding: NoSessionCapabilityExpectationSchema,
        publicComposer: NoSessionCapabilityExpectationSchema,
        editableInput: NoSessionCapabilityExpectationSchema,
        sendControl: NoSessionCapabilityExpectationSchema,
        loginWall: NoSessionCapabilityExpectationSchema,
        deeperInteraction: NoSessionCapabilityExpectationSchema,
        specialSurfaceIdentity: NoSessionCapabilityExpectationSchema,
      })
      .strict(),
...
const TARGETS: readonly NoSessionTarget[] = [
  {
    ...
    capabilityExpectation: {
      ...
      publicLanding: "EXPECTED",
      publicComposer: "EXPECTED",
      editableInput: "EXPECTED",
      sendControl: "EXPECTED",
      loginWall: "OPTIONAL_OR_REGION_DEPENDENT",
      deeperInteraction: "OPTIONAL_OR_REGION_DEPENDENT",
      specialSurfaceIdentity: "NOT_EXPECTED",
    },
  ...
  },
  {
    ...
    capabilityExpectation: {
      pageIdentity: "NOT_OBSERVABLE_WITHOUT_SESSION",
      publicLanding: "NOT_OBSERVABLE_WITHOUT_SESSION",
      publicComposer: "NOT_OBSERVABLE_WITHOUT_SESSION",
      editableInput: "NOT_OBSERVABLE_WITHOUT_SESSION",
      sendControl: "NOT_OBSERVABLE_WITHOUT_SESSION",
      loginWall: "EXPECTED",
      deeperInteraction: "NOT_OBSERVABLE_WITHOUT_SESSION",
      specialSurfaceIdentity: "NOT_OBSERVABLE_WITHOUT_SESSION",
    },
  ...
  },
  {
    ...
    capabilityExpectation: {
      pageIdentity: "EXPECTED",
      publicLanding: "EXPECTED",
      publicComposer: "OPTIONAL_OR_REGION_DEPENDENT",
      editableInput: "OPTIONAL_OR_REGION_DEPENDENT",
      sendControl: "OPTIONAL_OR_REGION_DEPENDENT",
      loginWall: "EXPECTED",
      deeperInteraction: "NOT_OBSERVABLE_WITHOUT_SESSION",
      specialSurfaceIdentity: "NOT_EXPECTED",
    },
  ...
  },
  {
    ...
    capabilityExpectation: {
      pageIdentity: "EXPECTED",
      publicLanding: "OPTIONAL_OR_REGION_DEPENDENT",
      publicComposer: "NOT_OBSERVABLE_WITHOUT_SESSION",
      editableInput: "NOT_OBSERVABLE_WITHOUT_SESSION",
      sendControl: "NOT_OBSERVABLE_WITHOUT_SESSION",
      loginWall: "OPTIONAL_OR_REGION_DEPENDENT",
      deeperInteraction: "NOT_OBSERVABLE_WITHOUT_SESSION",
      specialSurfaceIdentity: "EXPECTED",
    },
    authenticationExpectation: "AUTH_REQUIRED_FOR_DEEP_INTERACTION",
    identityRequirement: "ORIGIN_AND_PROVIDER_SURFACE_SIGNAL",
    officialProvenance: {
