...
Публичные HEAD проверки 2026-09-24: api health/ready 200, app 200, octoport.ru 200; /privacy, /support, /install 404. Содержание handoff уже есть в /root/octoport-control/logs/C/STORE0_PUBLIC_PAGES_HANDOFF_2026-09-23.md. Нужен конкретный владелец site/deploy границы и опубликованный контакт поддержки, не неподтверждённый личный адрес. Карточки/ZIP ещё не отправлены; доступ в кабинеты издателей этой проверкой не подтверждён. Общий roadmap и Safari не блокируют раннюю подачу.

Owner input: одно согласованное окно обычного входа в выделенный Octoport browser profile (совместить A/C OTP/login/import проверки, код и токены не в чат); утверждённый icon asset либо разрешение изготовить минимальный; если публичный support contact ещё не утверждён — дать его перед публикацией страницы. Разработка пакета и backend продолжается без ожидания этих ответов после разрешения resume.
