...
Status: **M4 ACCEPTED / M4Q R2 CORRECTIVE KNOWN-QUERY VISIBILITY ENRICHMENT PREPARED / WORK READBACK PENDING / M5 PAUSED**
## Current cursor
...
M4Q_R2_KNOWN_QUERY_VISIBILITY = PREPARED_PENDING_REMOTE_READBACK
