...
Status: **M4A ACCEPTED / M4B1 ACCEPTED + R3 CURRENT REACQUISITION ACCEPTED / M4B2 ACCEPTED / M4Q ACCEPTED WITH SOURCE LIMITATION / M4C R1 PREPARED PENDING READBACK**
## Current cursor
...
M4Q_RANKING_QUERY_LANE = SOURCE_UNAVAILABLE_DECLARED_LIMITATION
M4Q_KNOWN_RECALL_LIMITATION = ACTIVE
M4C = R1_PREPARED_PENDING_REMOTE_READBACK
